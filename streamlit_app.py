"""
Streamlit UI for Module 8 Session 2 Student Enrollment App.

This file is the UI/presentation layer. It uses the existing backend functions
from enrollment_starter.py and does not write SQL directly in the Streamlit UI.
"""
